  ...
  return (
    ...
    >
      <div className="col-span-4">
        <h1 className="mb-6 font-ubuntu md:mb-4">
        ...
        <p className="text-xl mb-8 w-[85%] lg:text-lg md:w-full xsm:text-base">
      ...
      <div className="col-span-3 md:row-start-1 md:row-end-2 md:w-4/5 md:justify-self-center sm:w-full">
