...
function AchievementCard({ children, number, image }: AchievementCardProps) {
  return (
    <li className="flex flex-col rounded-2xl text-center bg-almond-normal shadow-sm px-4 pb-8 items-center mdl:px-2 mdl:pb-6 md:max-w-lg md:self-center animate-[fadeBottom_1.4s]">
